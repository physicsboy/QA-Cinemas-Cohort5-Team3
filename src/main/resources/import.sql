...
INSERT INTO movie VALUES (9, 'Keanu Reeves, Riccardo Scamarcio', 'CLASS_18', 'After returning to the criminal underworld to repay a debt, John Wick discovers that a large bounty has been put on his life.', 'Action, Crime, Thriller', 122, TRUE, 'John Wick: Chapter 2', '2017-02-10');
INSERT INTO movie VALUES (10, 'Matt Damon, Tian Jing', 'CLASS_12A', 'European mercenaries searching for black powder become embroiled in the defense of the Great Wall of China against a horde of monstrous creatures.', ' Action, Adventure, Fantasy', 103, TRUE, 'The Great Wall', '2017-02-17');
INSERT INTO movie VALUES (11, 'Mahershala Ali', 'CLASS_18', 'A chronicle of the childhood, adolescence and burgeoning adulthood of a young black man growing up in a rough neighborhood of Miami.', 'Drama', 111, TRUE, 'Moonlight', '2016-11-18');
INSERT INTO movie VALUES (12, 'Amy Adams, Jeremy Renner', 'CLASS_12A', 'When twelve mysterious spacecraft appear around the world, linguistics professor Louise Banks is tasked with interpreting the language of the apparent alien visitors.', ' Drama, Mystery, Sci-F', 116, TRUE, 'Arrival', '2016-11-11');
INSERT INTO movie VALUES (13, 'Felicity Jones, Diego Luna', 'CLASS_12A', 'The Rebel Alliance makes a risky move to steal the plans for the Death Star, setting up the epic saga to follow.', 'Action, Adventure, Sci-F', 133, TRUE, 'Rogue One', '2016-12-16');
INSERT INTO movie VALUES (14, 'Dane DeHaan, Jason Isaacs', 'CLASS_12A', 'An ambitious young executive is sent to retrieve his company''s CEO from an idyllic but mysterious ''wellness center'' at a remote location in the Swiss Alps, but soon suspects that the spa''s treatments are not what they seem.', 'Drama, Fantasy, Horror ', 146, TRUE, 'A Cure for Wellness', '2017-02-17');
INSERT INTO movie VALUES (15, 'Ryan Gosling, Emma Stone', 'CLASS_12A', 'A jazz pianist falls for an aspiring actress in Los Angeles.', ' Comedy, Drama, Music', 128,  TRUE, 'La La Land', '2016-12-25');
INSERT INTO movie VALUES (16, 'Natalie Portman', 'CLASS_18', 'Following the assassination of President John F. Kennedy, First Lady Jacqueline Kennedy fights through grief and trauma to regain her faith, console her children, and define her husband''s historic legacy.', 'Biography, Drama, History', 100, TRUE, 'Jackie', '2016-12-02');
...
INSERT INTO ticket VALUES (3, 6.99, 'CHILD', 3, 4, 1);
INSERT INTO ticket VALUES (4, 7.49, 'CONCESSION',3, 3, 2);
INSERT INTO ticket VALUES (5, 12.99, 'PRMEIUM', 4, 4, 3);
